...
import com.curso.admin.catalogo.infrastructure.category.models.CategoryResponse;
...
public interface MockDsl {
    ...
    default CategoryID givenACategory(final String aName, final String aDescription, final boolean isActive) throws Exception {
        final var aRequestBody = new CreateCategoryInput(aName, aDescription, isActive);
    ...
    default ResultActions updateACategory(final Identifier anId, final UpdateCategoryInput aRequest) throws Exception {
