...
public class DeleteCategoryUseCaseIT {
    ...
    public void givenAValidId_whenCallsDeleteCategory_shouldBeOk(){
        ...
        Assertions.assertDoesNotThrow(() -> deleteCategoryUseCase.execute(exceptedId.getValue()));
    ...
    public void givenAValidId_whenGatewayThrowsException_shouldReturnException(){
        ...
        Assertions.assertThrows(IllegalStateException.class,() -> deleteCategoryUseCase.execute(exceptedId.getValue()));
        Mockito.verify(categoryGateway, Mockito.times(1)).deletedById(eq(exceptedId));
    }
